...
<template>
  <AuthLayout>
    <div class="flex flex-col gap-4">
      ...
      <button class="text-white bg-green-600 hover:bg-green-700 mt-4 rounded-md px-3 py-1.5 text-sm/6 font-semibold" @click="handleClickLogin">{{ isLoading ? 'Loading...' : 'Login'}}</button>
    </div>
  </AuthLayout>
</template>
<style scoped></style>